...
class TradeSession {
     ...
     * @param CorePlayer $receiver
     */
    public function __construct(CorePlayer $sender, CorePlayer $receiver) {
        $this->sender = $sender;
        ...
        $this->menu->setInventoryCloseListener(
            function(Player $player, Inventory $inventory): void {
                ...
                Urbis::getInstance()->getTradeManager()->removeSession($this->key);
            }
        );
    }
     ...
     * @return CorePlayer
     */
    public function getSender(): CorePlayer {
        return $this->sender;
    }
     ...
     * @return CorePlayer
     */
    public function getReceiver(): CorePlayer {
