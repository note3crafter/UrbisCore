...
class RemoveShardsCommand extends Command {

    /**
     * RemoveShardsCommand constructor.
     */
    public function __construct() {
        parent::__construct("removeshards", "Remove shards from a player's shards.", "/removeshards <player> <amount>", ["takeshards", "rmshards"]);
    }
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args): void{
		...
		if(isset($shards)) {
			...
			$player->subtractShards((int)$args[1]);
		}
		$sender->sendMessage(Translation::getMessage("removeShardsSuccess", [
