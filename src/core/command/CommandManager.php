...
use core\command\types\AuctionCommand;
use core\command\types\ChooseKitCommand;
...
use core\command\types\FakeKeyAllCommand;
use core\command\types\HudOnCommand;
use core\command\types\HudOffCommand;
use core\command\types\FakeArtifactAllCommand;
...
use core\command\types\OutpostCommand;
use core\command\types\WarpCommand;
...
use core\command\types\TpacceptCommand;
use core\command\types\TpadenyCommand;
use core\command\types\TellCommand;
use core\command\types\SpecialsCommand;
...
use core\command\types\ShardsTopCommand;
use core\faction\command\FactionCommand;
use core\gamble\command\CoinFlipCommand;
use core\command\types\AddShardsCommand;
use core\command\types\RemoveShardsCommand;
use core\bounty\command\BountyCommand;
use core\command\types\CEShopCommand;
use core\Urbis;
...
class CommandManager {
    ...
    public function __construct(Urbis $core) {
        $this->core = $core;
        $this->registerCommand(new OutpostCommand());
        $this->registerCommand(new AddMoneyCommand());
        $this->registerCommand(new ShardsTopCommand());
        $this->registerCommand(new RemoveMoneyCommand());
        $this->registerCommand(new CEShopCommand());
        $this->registerCommand(new SpecialsCommand());
        ...
        $this->registerCommand(new TpacceptCommand());
        $this->registerCommand(new TpadenyCommand());
        ...
        $this->registerCommand(new AddShardsCommand());
        $this->registerCommand(new RemoveShardsCommand());
        $this->registerCommand(new BountyCommand());
        //$this->registerCommand(new HudOffCommand());
        $this->registerCommand(new FakeKeyAllCommand());
        $this->registerCommand(new FakeArtifactAllCommand());
		//$this->registerCommand(new CapeFormCommand());
