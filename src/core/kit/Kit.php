...
class Kit {
     ...
     * @return bool
     */
	public function isInvFull(CorePlayer $player): bool{
...
//     * @param Item $item
//     */
//    public function giveItem(CorePlayer $player, Item $item): void{
...
//    }
     ...
     * @param CorePlayer $player
     */
    public function giveTo(CorePlayer $player): bool {
        if($this->isInvFull($player)){
