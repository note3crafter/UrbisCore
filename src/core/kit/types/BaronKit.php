...
class BaronKit extends Kit {
    ...
    public function __construct() {
        ...
        $items =  [
            ...
            Item::get(Item::ENCHANTED_GOLDEN_APPLE, 0, 16),
            Item::get(Item::GOLDEN_APPLE, 0, 32),
            Item::get(Item::WOOD, 0, 64),
            Item::get(Item::TORCH, 0, 64),
            Item::get(Item::OBSIDIAN, 0, 156),
            Item::get(Item::BEDROCK, 0, 156)
        ];
        parent::__construct("Baron", self::COMMON, $items, 43200);
    }
}