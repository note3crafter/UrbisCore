    ...
    public function __construct() {
        ...
        $items =  [
            ...
            (new CustomItem(Item::DIAMOND_SHOVEL, $name . "§r§7Shovel§r", [], [
                new EnchantmentInstance(Enchantment::getEnchantment(Enchantment::EFFICIENCY), 13),
                new EnchantmentInstance(Enchantment::getEnchantment(Enchantment::UNBREAKING), 5)
            ]))->getItemForm(),
        ...
        parent::__construct("Emperor", self::COMMON, $items, 43200);
    }
}