    ...
    public function __construct() {
        ...
        $items =  [
            ...
            (new CustomItem(Item::DIAMOND_BOOTS, $name . "§r§7Boots§r", [], [
                ...
                new EnchantmentInstance(Enchantment::getEnchantment(Enchantment::GEARS), 1)
            ]))->getItemForm(),
            (new CustomItem(Item::DIAMOND_SWORD, $name . "§r§7Sword§r", [], [
                ...
                new EnchantmentInstance(Enchantment::getEnchantment(Enchantment::UNBREAKING), 5),
                new EnchantmentInstance(Enchantment::getEnchantment(Enchantment::WITHER), 5),
                new EnchantmentInstance(Enchantment::getEnchantment(Enchantment::BLEED), 10),
                new EnchantmentInstance(Enchantment::getEnchantment(Enchantment::GUILLOTINE), 10),
                new EnchantmentInstance(Enchantment::getEnchantment(Enchantment::FLING), 1)
            ]))->getItemForm(),
        ...
        parent::__construct("Atlas", self::LEGENDARY, $items, 43200);
    }
}