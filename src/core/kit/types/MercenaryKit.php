...
class MercenaryKit extends Kit {

    /**
     * Mercenary constructor.
     */
    public function __construct() {
        $name = "§r§l§4Mercenary§r ";
        $items =  [
            (new CustomItem(Item::DIAMOND_HELMET, $name . "§r§7Helmet§r", [], [
                new EnchantmentInstance(Enchantment::getEnchantment(Enchantment::PROTECTION), 16),
        ...
        parent::__construct("Mercenary", self::COMMON, $items, 43200);
    }
}