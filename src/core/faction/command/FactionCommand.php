...
use core\faction\command\subCommands\TlSubCommand;
use core\faction\command\subCommands\ForceLeaderCommand;
use core\faction\command\subCommands\ForceJoinCommand;
...
class FactionCommand extends Command {
    ...
    public function __construct() {
		...
		$this->addSubCommand(new FactionManagerCommand());
        $this->addSubCommand(new TlSubCommand());
