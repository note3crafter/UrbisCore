...
use core\item\enchantment\types\GearsEnchantment;
...
use core\item\enchantment\types\OverloadEnchantment;
use core\item\enchantment\types\LifestealEnchantment;
use core\item\enchantment\types\FortuneEnchantment;
use core\Urbis;
...
class ItemManager {
    ...
    public function init() {
        ...
        self::registerEnchantment(new FortuneEnchantment());
        ...
        self::registerEnchantment(new \pocketmine\item\enchantment\Enchantment(Enchantment::EFFICIENCY, "Efficiency", Enchantment::RARITY_COMMON, Enchantment::SLOT_DIG, Enchantment::SLOT_SHEARS, 25));
        ...
        self::registerEnchantment(new SharpnessEnchantment(Enchantment::SHARPNESS, "Sharpness", Enchantment::RARITY_COMMON, Enchantment::SLOT_SWORD, Enchantment::SLOT_AXE, 23));
