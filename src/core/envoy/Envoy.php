...
class Envoy {
    ...
    public function spawn(): void {
        ...
        Urbis::getInstance()->getEnvoyManager()->spawnEnvoy($this->position);
    }
     ...
     *
     */
    public function claim(CorePlayer $player): void {
        $rewards = Urbis::getInstance()->getEnvoyManager()->getRewards();
    ...
    public function update(): void {
        ...
        $message = "§cThis Envoy is Dissapearing in \n§c" . gmdate("i:s", $time) . "§7...";
    ...
    public function despawn(): void {
        ...
        Urbis::getInstance()->getEnvoyManager()->despawnEnvoy($this->position);
    }
}