...
class LuckyBlock extends GlazedTerracotta {
    ...
    public function __construct() {
        ...
        $this->goodRewards = [
            function(CorePlayer $player, Position $position): void {
            ...
            function(CorePlayer $player, Position $position): void {
                $position->level->dropItem($position, (new ChestKit($player->getCore()->getKitManager()->getKitByName("Arcane")))->getItemForm());
            },
            function(CorePlayer $player, Position $position): void {
                $position->level->dropItem($position, (new ChestKit($player->getCore()->getKitManager()->getKitByName("Eros")))->getItemForm());
            },
            function(CorePlayer $player, Position $position): void {
    ...
    public function onBreak(Item $item, Player $player = null): bool {
        ...
        $add = $item->getEnchantmentLevel(\core\item\enchantment\Enchantment::CHARM) * 5;
